...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\n:root {\n  --light-gold: #ffe1a5;\n  --strong-gold: #fbd58a;\n  --white: #fff;\n  --gray-bg: #292929;\n  --gray-btn: #6f6f6f;\n  --gray-text: #aaaaaa;\n  --brown-text: #554221;\n  --general-border: 10px;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 2rem;\n  letter-spacing: 0.5px;\n  color: var(--brown-text);\n}\n\nmain {\n  height: 100vh;\n  width: 100vw;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.container {\n  position: relative;\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(4, 1fr);\n  grid-template-areas:\n    \"a b\"\n    \"a b\"\n    \"a b\"\n    \"c c\";\n\n  height: 70%;\n  width: 55%;\n\n  background-color: var(--gray-bg);\n\n  border-radius: calc(var(--general-border) * 2);\n}\n/* DAY SPECIFICS */\n\n.day-specifics {\n  grid-area: a;\n\n  display: grid;\n  grid-template-columns: 1fr 4fr;\n  grid-template-rows: 1fr 6fr;\n  align-items: center;\n\n  column-gap: 2rem;\n\n  padding: 3rem;\n\n  color: white;\n}\n\n.temps {\n  display: flex;\n\n  height: 5.6rem;\n  width: 12.8rem;\n\n  overflow: hidden;\n\n  background-color: var(--gray-btn);\n\n  border-radius: var(--general-border);\n}\n\n.btn {\n  height: 100%;\n  width: 50%;\n\n  background-color: inherit;\n\n  border: none;\n\n  font-size: 2rem;\n  color: var(--white);\n\n  cursor: pointer;\n}\n\n.btn-focus {\n  z-index: 1;\n\n  font-weight: bold;\n  color: black;\n\n  background-color: #ffcc65;\n  border-radius: var(--general-border);\n\n  box-shadow: 0rem 0rem 2rem 0rem rgb(41, 41, 41, 0.5);\n}\n\n.input-container {\n  position: relative;\n}\n\n.input-search {\n  height: 5.6rem;\n  width: 80%;\n\n  padding-left: 2rem;\n\n  border: none;\n  border-radius: var(--general-border);\n  background-color: rgb(255, 255, 255, 0.1);\n\n  font-size: 2.4rem;\n  font-family: inherit;\n  color: var(--white);\n\n  outline: none;\n}\n\n.btn-search {\n  position: absolute;\n  width: 6rem;\n  height: 100%;\n\n  right: 20%;\n  border: none;\n  border-radius: var(--general-border);\n  background-color: rgb(255, 255, 255, 0.2);\n\n  cursor: pointer;\n}\n\n.btn-search svg {\n  color: var(--white);\n  height: 3rem;\n  width: 3rem;\n}\n\n.btn-search:hover {\n  animation-duration: 0.5s;\n  animation-fill-mode: forwards;\n  animation-name: fadeinday;\n}\n\n.btn-search:hover svg {\n  color: var(--gray-bg);\n}\n\n.desc-container {\n  grid-column: 1 / -1;\n\n  display: flex;\n  flex-direction: column;\n  gap: 2rem;\n\n  font-size: 2.4rem;\n  font-weight: bold;\n\n  transform: translateY(-10%);\n\n  opacity: 0%;\n}\n\n.desc-container div {\n  display: flex;\n  gap: 2rem;\n}\n\n.desc-container div p {\n  font-weight: normal;\n}\n\n[data-day] {\n  font-weight: normal;\n  font-size: 1.8rem;\n  color: var(--gray-text);\n  transform: translateY(-55%);\n}\n\n/* ------------------------------------- */\n\n/* DAY OVERVIEW */\n\n.day-overview {\n  grid-area: b;\n  padding: 4.8rem 6.4rem;\n\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  justify-content: center;\n  gap: 1.6rem;\n\n  color: var(--white);\n}\n\n.day-overview span {\n  display: inline-block;\n}\n\n.day-overview h1 {\n  font-weight: lighter;\n  font-size: 13rem;\n  letter-spacing: -4px;\n}\n\n.day-overview h2 {\n  letter-spacing: 2px;\n  font-size: 3.2rem;\n}\n\n.day-overview p {\n  color: var(--gray-text);\n}\n\n.day-overview svg {\n  position: absolute;\n  height: 16rem;\n  width: 16rem;\n\n  bottom: 20%;\n  left: 15%;\n}\n\n/* DAYS PREVIEW */\n\n.days {\n  background-color: var(--light-gold);\n\n  display: grid;\n  grid-template-columns: repeat(8, 1fr);\n  grid-template-rows: 1fr;\n  grid-area: c;\n\n  overflow: hidden;\n  border-bottom-left-radius: var(--general-border);\n  border-bottom-right-radius: var(--general-border);\n}\n\n.day {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  justify-content: center;\n  background-color: var(--light-gold);\n  cursor: pointer;\n}\n\n.day:hover {\n  animation-duration: 0.5s;\n  animation-fill-mode: forwards;\n  animation-name: fadeinday;\n}\n\n.day p:first-of-type {\n  font-weight: 600;\n  font-size: 2rem;\n}\n\n.day svg {\n  height: 5rem;\n  width: 5rem;\n  font-weight: lighter;\n}\n\n.day1 {\n  background-color: var(--strong-gold);\n  box-shadow: 0rem 0rem 1.3rem 0rem rgb(41, 41, 41, 0.3);\n  z-index: 0;\n\n  border-radius: var(--general-border);\n}\n\n.fade-content {\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  animation-name: fadeincont;\n}\n\n.spinner {\n  position: absolute;\n  top: 30%;\n  left: 50%;\n  transform: translateX(-50%);\n\n  color: var(--white);\n  text-align: center;\n}\n\n.spinner p {\n  margin-bottom: 3rem;\n  font-size: 2.4rem;\n}\n\n.spinner svg {\n  height: 12rem;\n  width: 12rem;\n  animation: rotate 2s infinite linear;\n}\n\n.hidden {\n  display: none;\n}\n\n/* ------------------------------------- */\n\n/* ANIMATIONS */\n\n@keyframes fadeincont {\n  0% {\n    opacity: 0%;\n  }\n\n  100% {\n    opacity: 100%;\n  }\n}\n\n@keyframes fadeinday {\n  0% {\n    background-color: inherit;\n  }\n  100% {\n    background-color: var(--strong-gold);\n    box-shadow: 0rem 0rem 1.3rem 0rem rgb(41, 41, 41, 0.3);\n    z-index: 0;\n\n    border-radius: var(--general-border);\n  }\n}\n\n@keyframes rotate {\n  0% {\n    transform: rotate(0);\n  }\n\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n/* ------------------------------------- */\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,UAAU;EACV,SAAS;EACT,sBAAsB;AACxB;;AAEA;EACE,qBAAqB;EACrB,sBAAsB;EACtB,aAAa;EACb,kBAAkB;EAClB,mBAAmB;EACnB,oBAAoB;EACpB,qBAAqB;EACrB,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,qCAAqC;EACrC,eAAe;EACf,qBAAqB;EACrB,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb,YAAY;;EAEZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,qCAAqC;EACrC,kCAAkC;EAClC;;;;SAIO;;EAEP,WAAW;EACX,UAAU;;EAEV,gCAAgC;;EAEhC,8CAA8C;AAChD;AACA,kBAAkB;;AAElB;EACE,YAAY;;EAEZ,aAAa;EACb,8BAA8B;EAC9B,2BAA2B;EAC3B,mBAAmB;;EAEnB,gBAAgB;;EAEhB,aAAa;;EAEb,YAAY;AACd;;AAEA;EACE,aAAa;;EAEb,cAAc;EACd,cAAc;;EAEd,gBAAgB;;EAEhB,iCAAiC;;EAEjC,oCAAoC;AACtC;;AAEA;EACE,YAAY;EACZ,UAAU;;EAEV,yBAAyB;;EAEzB,YAAY;;EAEZ,eAAe;EACf,mBAAmB;;EAEnB,eAAe;AACjB;;AAEA;EACE,UAAU;;EAEV,iBAAiB;EACjB,YAAY;;EAEZ,yBAAyB;EACzB,oCAAoC;;EAEpC,oDAAoD;AACtD;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,UAAU;;EAEV,kBAAkB;;EAElB,YAAY;EACZ,oCAAoC;EACpC,yCAAyC;;EAEzC,iBAAiB;EACjB,oBAAoB;EACpB,mBAAmB;;EAEnB,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;;EAEZ,UAAU;EACV,YAAY;EACZ,oCAAoC;EACpC,yCAAyC;;EAEzC,eAAe;AACjB;;AAEA;EACE,mBAAmB;EACnB,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,wBAAwB;EACxB,6BAA6B;EAC7B,yBAAyB;AAC3B;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,mBAAmB;;EAEnB,aAAa;EACb,sBAAsB;EACtB,SAAS;;EAET,iBAAiB;EACjB,iBAAiB;;EAEjB,2BAA2B;;EAE3B,WAAW;AACb;;AAEA;EACE,aAAa;EACb,SAAS;AACX;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;EACnB,iBAAiB;EACjB,uBAAuB;EACvB,2BAA2B;AAC7B;;AAEA,0CAA0C;;AAE1C,iBAAiB;;AAEjB;EACE,YAAY;EACZ,sBAAsB;;EAEtB,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,qBAAqB;EACrB,uBAAuB;EACvB,WAAW;;EAEX,mBAAmB;AACrB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,oBAAoB;EACpB,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,YAAY;;EAEZ,WAAW;EACX,SAAS;AACX;;AAEA,iBAAiB;;AAEjB;EACE,mCAAmC;;EAEnC,aAAa;EACb,qCAAqC;EACrC,uBAAuB;EACvB,YAAY;;EAEZ,gBAAgB;EAChB,gDAAgD;EAChD,iDAAiD;AACnD;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;;EAEnB,uBAAuB;EACvB,mCAAmC;EACnC,eAAe;AACjB;;AAEA;EACE,wBAAwB;EACxB,6BAA6B;EAC7B,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,oBAAoB;AACtB;;AAEA;EACE,oCAAoC;EACpC,sDAAsD;EACtD,UAAU;;EAEV,oCAAoC;AACtC;;AAEA;EACE,sBAAsB;EACtB,6BAA6B;EAC7B,0BAA0B;AAC5B;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,2BAA2B;;EAE3B,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,oCAAoC;AACtC;;AAEA;EACE,aAAa;AACf;;AAEA,0CAA0C;;AAE1C,eAAe;;AAEf;EACE;IACE,WAAW;EACb;;EAEA;IACE,aAAa;EACf;AACF;;AAEA;EACE;IACE,yBAAyB;EAC3B;EACA;IACE,oCAAoC;IACpC,sDAAsD;IACtD,UAAU;;IAEV,oCAAoC;EACtC;AACF;;AAEA;EACE;IACE,oBAAoB;EACtB;;EAEA;IACE,yBAAyB;EAC3B;AACF;;AAEA,0CAA0C","sourcesContent":["* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\n:root {\n  --light-gold: #ffe1a5;\n  --strong-gold: #fbd58a;\n  --white: #fff;\n  --gray-bg: #292929;\n  --gray-btn: #6f6f6f;\n  --gray-text: #aaaaaa;\n  --brown-text: #554221;\n  --general-border: 10px;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 2rem;\n  letter-spacing: 0.5px;\n  color: var(--brown-text);\n}\n\nmain {\n  height: 100vh;\n  width: 100vw;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.container {\n  position: relative;\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(4, 1fr);\n  grid-template-areas:\n    \"a b\"\n    \"a b\"\n    \"a b\"\n    \"c c\";\n\n  height: 70%;\n  width: 55%;\n\n  background-color: var(--gray-bg);\n\n  border-radius: calc(var(--general-border) * 2);\n}\n/* DAY SPECIFICS */\n\n.day-specifics {\n  grid-area: a;\n\n  display: grid;\n  grid-template-columns: 1fr 4fr;\n  grid-template-rows: 1fr 6fr;\n  align-items: center;\n\n  column-gap: 2rem;\n\n  padding: 3rem;\n\n  color: white;\n}\n\n.temps {\n  display: flex;\n\n  height: 5.6rem;\n  width: 12.8rem;\n\n  overflow: hidden;\n\n  background-color: var(--gray-btn);\n\n  border-radius: var(--general-border);\n}\n\n.btn {\n  height: 100%;\n  width: 50%;\n\n  background-color: inherit;\n\n  border: none;\n\n  font-size: 2rem;\n  color: var(--white);\n\n  cursor: pointer;\n}\n\n.btn-focus {\n  z-index: 1;\n\n  font-weight: bold;\n  color: black;\n\n  background-color: #ffcc65;\n  border-radius: var(--general-border);\n\n  box-shadow: 0rem 0rem 2rem 0rem rgb(41, 41, 41, 0.5);\n}\n\n.input-container {\n  position: relative;\n}\n\n.input-search {\n  height: 5.6rem;\n  width: 80%;\n\n  padding-left: 2rem;\n\n  border: none;\n  border-radius: var(--general-border);\n  background-color: rgb(255, 255, 255, 0.1);\n\n  font-size: 2.4rem;\n  font-family: inherit;\n  color: var(--white);\n\n  outline: none;\n}\n\n.btn-search {\n  position: absolute;\n  width: 6rem;\n  height: 100%;\n\n  right: 20%;\n  border: none;\n  border-radius: var(--general-border);\n  background-color: rgb(255, 255, 255, 0.2);\n\n  cursor: pointer;\n}\n\n.btn-search svg {\n  color: var(--white);\n  height: 3rem;\n  width: 3rem;\n}\n\n.btn-search:hover {\n  animation-duration: 0.5s;\n  animation-fill-mode: forwards;\n  animation-name: fadeinday;\n}\n\n.btn-search:hover svg {\n  color: var(--gray-bg);\n}\n\n.desc-container {\n  grid-column: 1 / -1;\n\n  display: flex;\n  flex-direction: column;\n  gap: 2rem;\n\n  font-size: 2.4rem;\n  font-weight: bold;\n\n  transform: translateY(-10%);\n\n  opacity: 0%;\n}\n\n.desc-container div {\n  display: flex;\n  gap: 2rem;\n}\n\n.desc-container div p {\n  font-weight: normal;\n}\n\n[data-day] {\n  font-weight: normal;\n  font-size: 1.8rem;\n  color: var(--gray-text);\n  transform: translateY(-55%);\n}\n\n/* ------------------------------------- */\n\n/* DAY OVERVIEW */\n\n.day-overview {\n  grid-area: b;\n  padding: 4.8rem 6.4rem;\n\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  justify-content: center;\n  gap: 1.6rem;\n\n  color: var(--white);\n}\n\n.day-overview span {\n  display: inline-block;\n}\n\n.day-overview h1 {\n  font-weight: lighter;\n  font-size: 13rem;\n  letter-spacing: -4px;\n}\n\n.day-overview h2 {\n  letter-spacing: 2px;\n  font-size: 3.2rem;\n}\n\n.day-overview p {\n  color: var(--gray-text);\n}\n\n.day-overview svg {\n  position: absolute;\n  height: 16rem;\n  width: 16rem;\n\n  bottom: 20%;\n  left: 15%;\n}\n\n/* DAYS PREVIEW */\n\n.days {\n  background-color: var(--light-gold);\n\n  display: grid;\n  grid-template-columns: repeat(8, 1fr);\n  grid-template-rows: 1fr;\n  grid-area: c;\n\n  overflow: hidden;\n  border-bottom-left-radius: var(--general-border);\n  border-bottom-right-radius: var(--general-border);\n}\n\n.day {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  justify-content: center;\n  background-color: var(--light-gold);\n  cursor: pointer;\n}\n\n.day:hover {\n  animation-duration: 0.5s;\n  animation-fill-mode: forwards;\n  animation-name: fadeinday;\n}\n\n.day p:first-of-type {\n  font-weight: 600;\n  font-size: 2rem;\n}\n\n.day svg {\n  height: 5rem;\n  width: 5rem;\n  font-weight: lighter;\n}\n\n.day1 {\n  background-color: var(--strong-gold);\n  box-shadow: 0rem 0rem 1.3rem 0rem rgb(41, 41, 41, 0.3);\n  z-index: 0;\n\n  border-radius: var(--general-border);\n}\n\n.fade-content {\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  animation-name: fadeincont;\n}\n\n.spinner {\n  position: absolute;\n  top: 30%;\n  left: 50%;\n  transform: translateX(-50%);\n\n  color: var(--white);\n  text-align: center;\n}\n\n.spinner p {\n  margin-bottom: 3rem;\n  font-size: 2.4rem;\n}\n\n.spinner svg {\n  height: 12rem;\n  width: 12rem;\n  animation: rotate 2s infinite linear;\n}\n\n.hidden {\n  display: none;\n}\n\n/* ------------------------------------- */\n\n/* ANIMATIONS */\n\n@keyframes fadeincont {\n  0% {\n    opacity: 0%;\n  }\n\n  100% {\n    opacity: 100%;\n  }\n}\n\n@keyframes fadeinday {\n  0% {\n    background-color: inherit;\n  }\n  100% {\n    background-color: var(--strong-gold);\n    box-shadow: 0rem 0rem 1.3rem 0rem rgb(41, 41, 41, 0.3);\n    z-index: 0;\n\n    border-radius: var(--general-border);\n  }\n}\n\n@keyframes rotate {\n  0% {\n    transform: rotate(0);\n  }\n\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n/* ------------------------------------- */\n"],"sourceRoot":""}]);
// Exports
...
const apiCalls = (() => {
  ...
  function _createWeatherDays(daysWeather) {
    ...
    const weatherDays = daysWeather.map((day, index) => ({
      town: city,
      nation: country,
      day: `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), index), formatDay)}`,
      date: `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), index), formatDate)}`,
...
/* harmony import */ var _dataHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dataHandler */ "./src/js/dataHandler.js");
/* harmony import */ var _viewHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./viewHandler */ "./src/js/viewHandler.js");
/* eslint-disable no-use-before-define */
...
const init = (() => {
  ...
  async function getCurrentCity(lat, lon) {
    try {
      const curCity = await _dataHandler__WEBPACK_IMPORTED_MODULE_1__.apiCalls.getCityCoords(lat, lon);
      apiCords(curCity);
    } catch (err) {
      console.error(err);
    }
  ...
  async function apiCords(city) {
    try {
      await _dataHandler__WEBPACK_IMPORTED_MODULE_1__.apiCalls.getPlaceCoords(city);
      const getWeatherDaysArr = _dataHandler__WEBPACK_IMPORTED_MODULE_1__.apiCalls.getArray();
      return _viewHandler__WEBPACK_IMPORTED_MODULE_2__.viewLogic.handleDisplay(getWeatherDaysArr, city);
    } catch (err) {
      console.error(err);
    }
  }
  ...
  metricBtn.forEach((btn) =>
    btn.addEventListener("click", (e) => _viewHandler__WEBPACK_IMPORTED_MODULE_2__.viewLogic.checkMetric(e.target))
  );
})();
